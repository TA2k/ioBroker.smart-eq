...
systemDictionary = {
  'smart-eq adapter settings': {
    en: 'Adapter settings for smart-eq',
    de: 'Adaptereinstellungen für smart-eq',
    ru: 'Настройки адаптера для smart-eq',
    pt: 'Configurações do adaptador para smart-eq',
    nl: 'Adapterinstellingen voor smart-eq',
    fr: "Paramètres d'adaptateur pour smart-eq",
    it: "Impostazioni dell'adattatore per smart-eq",
    es: 'Ajustes del adaptador para smart-eq',
    pl: 'Ustawienia adaptera dla smart-eq',
    'zh-cn': 'smart-eq的适配器设置',
  },
  'App Email': {
    en: 'App Email',
    de: 'App-E-Mail',
